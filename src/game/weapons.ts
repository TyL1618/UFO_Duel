...
export const WEAPON_DEFS: WeaponDef[] = [
  ...
  { id: 'acid',      label: '燃燒彈',   icon: '🔥', damage: 6,  ammo: 2, desc: '命中後施加燃燒：每回合 6 傷害，持續 3 回合' },
  ...
  { id: 'freeze',    label: '凍結彈',   icon: '❄️', damage: 15, ammo: 2, desc: '命中後凍結目標 1 回合，整回合無法移動與射擊，護盾可阻擋凍結效果' },
  { id: 'trap',      label: '陷阱地雷', icon: '⚠️', damage: 0,  ammo: 3, desc: '在地圖格子上放置陷阱，任何飛碟踩上即觸發 40 傷害爆炸，持續 8 回合' },
